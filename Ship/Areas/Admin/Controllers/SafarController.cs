...
namespace Ship.Areas.Admin.Controllers
{
    ...
    public class SafarController : Controller
    {
        ...
        [HttpPost]
        public PartialViewResult GetListSafar(int IdSoom)
        {
            int IdUser = int.Parse(User.Identity.Name);

            var dd = SiteSettingBLL.GetListSafar(IdUser, IdSoom).ToList();

            return PartialView("~/Areas/Admin/Views/Safar/ListSafar.cshtml", dd);
        }
        ...
        public PartialViewResult _Add(int Id = 0)
        {
            ...
            return PartialView("~/Areas/Admin/Views/Safar/_Add.cshtml", itm.Soom);
        }
        public PartialViewResult EditSafarMaster(int Id, int IdSoom)
        {
            ...
            return PartialView("~/Areas/Admin/Views/Safar/_Edit.cshtml", dd);
        }
        ...
        public PartialViewResult GetDeteilSafar(int Id, int IdSoom)
        {
            ...
            return PartialView("~/Areas/Admin/Views/Safar/_EditDeteilSafar.cshtml", dd);
        }
        ...
        public PartialViewResult GetListAfradRelation(int IdSafar, int IdSoom)
        {
            ...
            return PartialView("~/Areas/Admin/Views/Safar/Partial/GetListAfrad.cshtml", dd);
        }
        ...
        public PartialViewResult GetListSafarToHandMoney(int IdSoom, int IdSafar)
        {
            ...
            return PartialView("~/Areas/Admin/Views/Safar/Partial/GetListHandMoney.cshtml", dd);
        }
        ...
        public PartialViewResult GetListFactor(int IdSoom, int IdSafar)
        {
            ...
            var dd = SiteSettingBLL.GetListFactor(IdSafar, IdSoom, 14);

            return PartialView("~/Areas/Admin/Views/Safar/Partial/GetListFactorForosh.cshtml", dd);
        }
        ...
        public JsonResult DeleteFactor(int IdSafar, int IdSoom, long Id, int IdType)
        {
            ...
            return Json(SiteSettingBLL.DeleteFactor(IdUser, IdSafar, IdSoom, Id, IdType));
        }


        [HttpPost]
        public JsonResult RefreshNote(int IdSoom, long IdAfrad)
        {
            return Json(SiteSettingBLL.RefreshNote(IdSoom, IdAfrad));
        }
        ...
        [HttpPost]
        public JsonResult TotalMosaede(long IdNote, long IdPersonnel)
        {
            if (IdNote == 0)
            {
                return Json(0);
            ...
            var tt = SiteSettingBLL.TotalMosaede(IdNote, IdPersonnel);
            return Json(tt);
        }


        [HttpPost]
        public JsonResult RowBimeChange(long Id, bool Status)
        {
            return Json(SiteSettingBLL.RowBimeChange(Id, Status));
        }
        ...
        public PartialViewResult GetListFactorTamirat(int IdSoom, int IdSafar)
        {
            ...
            var dd = SiteSettingBLL.GetListFactor(IdSafar, IdSoom, 16);

            return PartialView("~/Areas/Admin/Views/Safar/Partial/GetListFactorTamirat.cshtml", dd);
        }
        ...
        public JsonResult AddFactorForoshTamirat(int IdSoom, int IdSafar, string IdKala, decimal? Weight, string Tozihat, string Price, string CreateDate, decimal? Tedad)
        {
            ...
            return Json(SiteSettingBLL.AddFactorForoshTamirat(IdUser, IdSoom, IdSafar, IdKala, Weight, Tozihat, long.Parse(Price), CreateDate, Tedad));
        }
        ...
        public PartialViewResult GetListFactorMahtaiaj(int IdSoom, int IdSafar)
        {
            ...
            var dd = SiteSettingBLL.GetListFactor(IdSafar, IdSoom, 18);

            return PartialView("~/Areas/Admin/Views/Safar/Partial/GetListFactorMahtaiaj.cshtml", dd);
        }
        ...
        public JsonResult AddFactorForoshMahtaiaj(int IdSoom, int IdSafar, int IdKala, decimal? Weight, string Tozihat, string Price, string CreateDate, decimal? Tedad, int Idunit)
        {
            ...
            return Json(SiteSettingBLL.AddFactorForoshMahtaiaj(IdUser, IdSoom, IdSafar, IdKala, Weight, Tozihat, long.Parse(Price), CreateDate, Tedad, Idunit));
        }
        ...
        public PartialViewResult GetListFactorKharid(int IdSoom, int IdSafar)
        {
            ...
            var dd = SiteSettingBLL.GetListFactor(IdSafar, IdSoom, 13);

            return PartialView("~/Areas/Admin/Views/Safar/Partial/GetListFactorKharid.cshtml", dd);
        }
        ...
        public JsonResult AddFactorForoshKharid(int IdSoom, int IdSafar, int IdKala, decimal? Weight, string Tozihat, string Price, string CreateDate, decimal? Tedad, int Idunit)
        {
            ...
            return Json(SiteSettingBLL.AddFactorForoshKharid(IdUser, IdSoom, IdSafar, IdKala, Weight, Tozihat, long.Parse(Price), CreateDate, Tedad, Idunit));
        }
        ...
        public PartialViewResult ToShowPage(int Id, string IdSafar, string IdShip)
        {
            ...
            if (Id == 1)
            {
                Page = "~/Areas/Admin/Views/Safar/Partial/ListAfrad.cshtml";
            }
            if (Id == 2)
            {
                Page = "~/Areas/Admin/Views/Safar/Partial/HandMoney.cshtml";
            }
            if (Id == 3)
            {
                Page = "~/Areas/Admin/Views/Safar/Partial/FactorKharid.cshtml";
            }
            if (Id == 4)
            {
                Page = "~/Areas/Admin/Views/Safar/Partial/FactorForosh.cshtml";
            }
            if (Id == 5)
            {
                Page = "~/Areas/Admin/Views/Safar/Partial/FactorTamirat.cshtml";
            }
            if (Id == 6)
            {
                Page = "~/Areas/Admin/Views/Safar/Partial/FactorMahtaiaj.cshtml";
            }
            if (Id == 7)
            {
                using (var x = new GolatehEntities())
                {
                    ...
                    return PartialView("~/Areas/Admin/Views/Safar/Partial/_EditMaster.cshtml", dd);
                }
            }
        ...
        public JsonResult ChekerOpenSafar(int IdSafar, int IdSoom)
        {
            ...
            using (var x = new GolatehEntities())
            {
                if (x.Safar.AsNoTracking().Any(v => v.Id == IdSafar && v.IsActive == true && v.IdSoom == IdSoom && v.Soom.IdPersonnel == IdUser))
                {
